...
def get_AUC_ROC_value(X_test, Y_test, model):
    ...
    auc_roc = roc_auc_score(y_true = true, y_score = pred)
#     print("AUC_ROC:", auc_roc)
    return auc_roc

def get_train_test_split_data(data_list, labels, test_size=0.33, random_state=50, shuffle=False):
    X_train, X_test, Y_train, Y_test = train_test_split(data_list, labels, shuffle=shuffle,
